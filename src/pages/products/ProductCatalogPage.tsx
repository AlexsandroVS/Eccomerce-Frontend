...
import { productUtils } from '../../utils/product.utils'; // Importar productUtils
...
const ProductCatalogPage: React.FC = () => {
  ...
  // FUNCIÓN CORREGIDA: Usar productUtils igual que en ProductsPage
  const getProductPrimaryImage = useCallback((product: Product): string => {
    // Usar la misma lógica que en ProductsPage
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product, index) => {
              ...
              const primaryImage = getProductPrimaryImage(product); // Usar función corregida
